...
import { BirthData, ChartResult, calculateChart } from '@natal-chart/core';
...
export const ChartProvider: React.FC<ChartProviderProps> = ({ children }) => {
  ...
  const calculate = useCallback(async (data: BirthData) => {
    setLoading(true);
    setError(null);
    ...
    try {
      ...
      // Also save birth data for future reference
      try {
