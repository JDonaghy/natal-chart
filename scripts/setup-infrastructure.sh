...
echo "   e. Authentication > Settings > Authorized domains > Add: natal-chart-3ew.pages.dev"
echo "      (jdonaghy.github.io is a stale redirect stub as of #31 — do not add it)"
